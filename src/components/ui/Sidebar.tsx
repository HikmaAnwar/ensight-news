  ...
  return (
    <aside className="w-[480px]">
      <Card className="bg-background border border-border shadow-card p-6 rounded-2xl">
        <Text className="font-bold text-blueblack-white text-xl mb-4">
          Popular This Week
        </Text>
        ...
        {articles.map((article, index) => (
          <div key={article.slug}>
            ...
            >
              <Text className="text-blueblack-white font-semibold hover:text-red-600 hover:underline cursor-pointer transition-colors duration-200">
                {article.title}
              </Text>
