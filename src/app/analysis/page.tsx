              ...
              {Array.isArray(selectedArticle.content) ? (
                ...
                <>
                  ...
                  <Text
                    ...
                    style={{ color: "var(--color-blueblack-white)" }}
                  >
                    Ethiopia has been experiencing significant economic growth
                    over the past decade, emerging as one of Africa’s
                    fastest-growing economies. The government’s ambitious
                    economic reforms have played a crucial role in driving this
                    growth, focusing on liberalizing key sectors and attracting
                    foreign investment.
                  </Text>
                  ...
                  <Text
                    ...
                    style={{ color: "var(--color-blueblack-white)" }}
                  >
                    The latest inflation data indicates a year-on-year rise of
                    24.5% in consumer prices. Food inflation remains a major
                    contributor, driven by supply chain disruptions and
                    fluctuating global commodity prices. Non-food inflation has
                    also seen an uptick, particularly in housing and utilities.
                  </Text>
                  ...
                  <Text
                    ...
                    style={{ color: "var(--color-blueblack-white)" }}
                  >
                    In response to rising inflation, the National Bank of
                    Ethiopia is expected to tighten monetary policy. Potential
                    measures include increasing the benchmark interest rate and
                    implementing stricter credit controls to curb excess
                  ...
                  <Text
                    ...
                    style={{ color: "var(--color-blueblack-white)" }}
                  >
                    Higher inflation and borrowing costs could affect
                    businesses’ operating expenses and consumer demand.
                    Companies are advised to review their pricing strategies and
                    cost structures to remain competitive in the changing
                  ...
                  >
                    ...
                    must stay agile in navigating inflationary pressures and
                    policy shifts. Staying informed and proactively adjusting
                    business strategies will be key to resilience and growth.
                  </Text>
                </>
              )}
            </div>
